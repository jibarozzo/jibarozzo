...
- **Distance-Based Redundancy Analyses (db-RDA)**: Utilizing dimensional reduction techniques to extract meaningful patterns from leaf trait data.
- **Linear models**: Applying general linear model and linear mixed models to ecological data.
